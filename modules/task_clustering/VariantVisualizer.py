...
class VariantVisualizer:
    ...
    def __init__(self, graph, output_directory):
        self.graph = graph
        ...
        self.output_directory_colored = os.path.join(output_directory, "variant_visualizations_colored")
        self.output_directory_abbrev = os.path.join(output_directory, "variant_visualizations_abbrev")
